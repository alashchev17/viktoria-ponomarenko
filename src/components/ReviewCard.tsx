...
export const ReviewCard = ({ review }: ReviewCardProps) => {
  ...
  return (
    <div
      className={`px-4 py-4 bg-bezh rounded-[6px] flex ${reviewType === 'audio' || reviewType === 'text' ? 'flex-col' : 'flex-col-reverse'} items-start gap-6 max-w-[320px] min-w-[320px] h-[435px]`}
    >
